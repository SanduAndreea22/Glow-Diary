...
class CollectionAdmin(admin.ModelAdmin):
    ...
    list_display = ("nume", "recomandata_saptamana", "recomandata_sezon", "data_creare")
    list_editable = ("recomandata_saptamana", "recomandata_sezon")
...
class ContactMessageAdmin(admin.ModelAdmin):
    list_display = ("nume", "email", "produs_brand", "citit", "data")
    list_editable = ("citit",)
    list_filter = ("citit",)
    search_fields = ("nume", "email", "produs_brand", "mesaj")
